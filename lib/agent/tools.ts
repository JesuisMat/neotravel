...
const calculerDevisInputSchema = z.object({
  ...
  heure_depart: z.string().describe("Heure de départ souhaitée au format HH:MM (ex: 08:30)"),
  date_retour: z.string().optional().describe("Date de retour au format YYYY-MM-DD"),
  heure_retour: z.string().optional().describe("Heure de retour souhaitée au format HH:MM"),
...
const envoyerDevisInputSchema = z.object({
  ...
  heure_depart: z.string().optional().describe("Heure de départ souhaitée (HH:MM)"),
  date_retour: z.string().optional().describe("Date de retour"),
  heure_retour: z.string().optional().describe("Heure de retour souhaitée (HH:MM)"),
      ...
      if (params.demande_id) {
        await supabase
          ...
          .update({
            ...
            heure_depart: params.heure_depart ?? undefined,
            date_retour: params.date_retour ?? undefined,
            heure_retour: params.heure_retour ?? undefined,
